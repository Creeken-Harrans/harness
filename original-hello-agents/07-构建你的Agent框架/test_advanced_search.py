"""
第七章 构建你的Agent框架 - 测试高级搜索工具
"""
from dotenv import load_dotenv
from my_advanced_search import create_advanced_search_registry, MyAdvancedSearchTool  # type: ignore[reportMissingImports]  # 运行时通过 sys.path 解析同目录模块
